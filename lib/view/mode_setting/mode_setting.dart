...
import 'package:booster_game/view/mode_setting/appbar_setting.dart';
                      ...
                      Obx(
                        () => SliderTheme(
                          ...
                          child: Slider(
                            ...
                            divisions: 100,
                            label:
                                '${controller.brightnessLevel.value.round()}%',
                            onChanged:
                                controller.brightnessEnabled.value
                      ...
                      Obx(
                        () => SliderTheme(
                          ...
                          child: Slider(
                            ...
                            divisions: 100,
                            label:
                                '${controller.ringtoneVolume.value.round()}%',
                            onChanged:
                                controller.ringtoneEnabled.value
                                    ? (val) =>
                        ...
                        () => Column(
                          children: [
                            ...
                            Row(
                              children: [
                                Expanded(
                                  child: _buildFpsOption(60, controller),
                                ),
                                SizedBox(width: 12),
                                Expanded(
                                  child: _buildFpsOption(90, controller),
                                ),
                              ],
                            ),
                            SizedBox(height: 12),
                            ...
                            Row(
                              children: [
                                Expanded(
                                  child: _buildFpsOption(120, controller),
                                ),
                                SizedBox(width: 12),
                                Expanded(
